...
def main():
    ...
    if mode!="PAPER": raise RuntimeError("v0.6 refuses to run outside PAPER mode")
    ...
    print("Polymarket Copy Engine v0.6 | PAPER | leaders={} | build_window={}s | session_gap={}s | settlement_check={}s | strategies=24".format(len(leaders),window,session_gap,settlement_interval),flush=True)
