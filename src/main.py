...
def main():
    ...
    print("Polymarket Copy Engine v0.8.1 | PAPER | leaders={} | build_window={}s | session_gap={}s | settlement_check={}s | strategies=24".format(len(leaders),window,session_gap,settlement_interval),flush=True)
