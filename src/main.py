...
def main():
    ...
    if mode!="PAPER": raise RuntimeError("v0.8.1 refuses to run outside PAPER mode")
    ...
    print("Polymarket Copy Engine v0.8.1 | PAPER | leaders={} | build_window={}s | session_gap={}s | settlement_check={}s | strategies=25".format(len(leaders),window,session_gap,settlement_interval),flush=True)
